 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Jamal's plugin
 * Plugin URI:        https://sakim.me
 * Description:       plugin personnalisé qui permettra d'ajouter des fonctionnalités d'un formulaire de contact, dans la page Contact Us.
 * Version:           1.0.0
 ...
 */
 ...
 $jamalPlugin = new jamalPlugin();


//  activation
register_activation_hook(
	__FILE__,
	[$jamalPlugin,'activation']
);
...
register_uninstall_hook(
	__FILE__,
    [$jamalPlugin,'uninstallation']
);

add_shortcode('jamalsForm',[$jamalPlugin,'form']);
